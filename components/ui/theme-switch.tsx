      ...
      >
        {showActiveIconOnly ? (
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="z-10 flex h-6 w-6 items-center justify-center rounded-full bg-foreground text-background">
            ...
            <div className="flex h-full w-full items-center justify-between">
              {icons.map((icon, idx) => {
                ...
                return (
                  <div
                    className={cn(
                      "z-10 flex h-6 w-6 cursor-pointer items-center justify-center rounded-full transition-opacity duration-200",
